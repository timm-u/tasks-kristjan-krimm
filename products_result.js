...
let string =
  "Cheapest product without discount is " +
  cheapestWithoutDiscount.name +
  " (costs " +
  cheapestWithoutDiscount.price +
  "), ";
string +=
  "considering discount is " +
  cheapestWithDiscount.name +
  " (costs " +
  cheapestWithDiscount.discountPrice +
  ") and they ";
if (sameType) {
  string += "are ";
} else {
...
string +=
  "Most expencive product is " +
  mostExpencive.name +
  " and it costs " +
  mostExpencive.discountPrice +
  ".";
